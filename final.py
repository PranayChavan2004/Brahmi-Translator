...
def predict_chars(images):
    ...
    num_to_name = {
        0: 'a', 1: 'a(3)', 2: 'a(4)', 3: 'a(5)',
        # KEEP YOUR COMPLETE ORIGINAL DICTIONARY HERE
        # ...
        285: 'yu', 286: 'yuu'
    }
    ...
    for image_name in images:
        ...
        # Resize image to CNN expected size
        curImg = cv2.resize(image_name, (32, 32))
...
#loading model
model = keras.models.load_model(r"C:\Users\pranay umesh chavan\BRAHMI\final_bramhi\models\MODEL\model.h5")
